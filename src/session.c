...
// This function can be altered to respond more specifically to particular
// errors, e.g. CURLE_PARTIAL_FILE
bool process_status(const char *fcn_name, CURL *session, const CURLcode res, 
    ...
    if (response_code >= 500) {
        // We could treat different 50x errors differently here
